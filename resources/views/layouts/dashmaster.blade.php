        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span>
                    ...
                    <a class="dropdown-item" href="{{ route('logouts') }}"><i class="ft-power"></i> تسجيل
                                 الخروج </a>
...
<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item active"><a href="{{ LaravelLocalization::localizeUrl('/dash') }}"><i class="la la-mouse-pointer"></i><span
                class="menu-title" data-i18n="nav.add_on_drag_drop.main">{{__('lang.home')}}</span></a>
            </li>

        <li class="nav-item"><a href="{{route('addcat')}}"><i class="la la-home"></i>
            ...
            <div class="list-group">   
                <a href="#" class="list-group-item list-group-item-action active"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>
                  المنتجات
                </a>
                <a href="{{route('addproduct')}}" class="list-group-item list-group-item-action">اضافه منتج جديد</a>
            <a href="{{route('showproduct')}}" class="list-group-item list-group-item-action">عرض المنتجات</a>
            <a href="{{route('deletproduct')}}" class="list-group-item list-group-item-action">بيع منتج</a>
...
<!-- BEGIN VENDOR JS-->
<script type="text/javascript" src="{{asset(css/admin/vendors/js/vendors.min.js')}}" ></script>
<!-- BEGIN VENDOR JS-->
