...
<div id="_desktop_verticalmenu" class="nov-verticalmenu block" data-count_showmore="6">
    <div class="box-content block_content">
      ...
      <li class="item  parent " ><a href="#" title="{{$item['name']}}"><i class="hasicon nov-icon" ><img src="{{asset('storage/photo/'.$item->photo)}}"  ></i> {{$item['name']}}</a><span class="show-sub fa-active-sub"></span><span class="menu-sub-title">Dell. HP, Macbook, Alienware and etc...</span><div class="dropdown-menu" style="width:222px">
</div>     
    </li> 
      @endforeach
          </ul>
